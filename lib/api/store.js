...
function seedVaults() {
  ...
  return [
    v({
      ...
      description:
        "Senior USDC supply tranche on Aave V3 Base. Battle-tested money market with deep liquidity.",
      allocation_pct: 0.28,
    }),
    v({
      ...
      description:
        "Curated Morpho Blue USDC market with conservative collateral factors and active curators.",
      allocation_pct: 0.22,
    }),
    v({
      ...
      description:
        "Compound V3 USDC supply on Arbitrum. Minimalist single-asset market, audited oracle.",
      allocation_pct: 0.18,
    }),
    v({
      ...
      description:
        "Higher-yield USDT strategy via Dolomite money market. Opportunistic tier, capacity constrained.",
      allocation_pct: 0.08,
    }),
    v({
      ...
      description:
        "Tokenized short-duration T-bill exposure settled in USDC. Lowest-volatility floor allocation.",
      allocation_pct: 0.12,
    }),
    v({
      ...
      description:
        "Curated Morpho Blue USDT market on Arbitrum with institutional curators.",
      allocation_pct: 0.07,
    }),
    v({
      ...
      description:
        "Aave V3 USDT on Arbitrum. Temporarily paused pending a parameter governance update.",
      allocation_pct: 0.0,
    }),
    v({
      ...
      description:
        "Compound V3 USDC supply on Base. Core-tier diversifier for Base-denominated flows.",
      allocation_pct: 0.05,
    }),
  ];
}
...
function seedDeliveries(store) {
  ...
  store.deliveries.push(
    mk(0, "position.active", "delivered"),
    mk(1, "position.rebalanced", "delivered"),
...
function seedPartners() {
  ...
  // revenue_share_pct is the partner's share of the 25% protocol performance
  // fee on generated yield: 50% is the standard deal, 80% the ceiling.
  return [
    p({
      id: "ptn_seed_acme",
      name: "Acme Wallet",
